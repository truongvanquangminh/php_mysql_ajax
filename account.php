...
$getAccount = "SELECT * FROM `user` WHERE `name` = '" . $name . "';";
$res = $conn->query($getAccount);
if ($res->num_rows > 0) {
	$row = $res->fetch_assoc();
	$html = '<form action="" method="POST">
					Name: <input type="text" name="name" value="' . $row['name'] . '">
					Email: <input type="text" name="email" value="' . $row['email'] . '">
					National: <input type="text" name="national" value="' . $row['national'] . '">
						...
						<div class="row">
							<div class="shopper-info">
								...
								if (isset($_POST['update'])) {
									if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['national']) && isset($_POST['position']) && isset($_POST['phone'])) {
