						...
						<div class="row">
							<div class="shopper-info">
								...
								if (isset($_POST['add'])) {
									...
									if (empty($_POST['name'])) {
										$msg[] = "Vui lòng nhập tên sản phẩm <br>";
									}

									if (empty($_POST['price'])) {
										$msg[] = "Vui lòng nhập giá sản phẩm <br>";
									}

									if(move_uploaded_file($tempname, $folder)) {
										// $msg[] = "Thêm sản phẩm thành công <br>";
									}

									if (!empty($_POST['name']) && !empty($_POST['price'])) {
										$product = "INSERT INTO `products`(`name`, `price`, `image`, `user_id`)
													VALUES ('" . $_POST['name'] . "',
															'" . $_POST['price'] . "',
															'" . $_FILES['image']['name'] . "',
															'" . $_SESSION['user']['id'] . "');";
								...
								<form action="" method="POST" enctype="multipart/form-data">
									...
									?>
									<input type="text" hidden value="<?php echo $row['id']; ?>">
